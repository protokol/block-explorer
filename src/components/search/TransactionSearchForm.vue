<template>
  <div>
    ...
    <NFTSearch
      v-if="
        transactionTypeGroup === getTypeGroupTransaction.NFT_BASE ||
        transactionTypeGroup === getTypeGroupTransaction.NFT_EXCHANGE
      "
...
import NFTSearch from "@/components/search/nft/NFTSearch.vue";
...
export default class TransactionSearchForm extends Vue {
  ...
  private transactionTypeProp = -1;
  private transactionTypeGroup = -1;
  ...
  private onTypeChange(event: any) {
    ...
    this.transactionTypeProp = type;
    this.transactionTypeGroup = typeGroup;
